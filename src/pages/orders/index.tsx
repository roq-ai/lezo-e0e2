...
export function OrderListPage(props: OrderListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrders({
        relations: ['user', 'organization', 'complaint.count', 'delivery.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['customer_name.contains', 'order_status.contains', 'delivery_location.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'delivery_location', header: 'Delivery Location', accessorKey: 'delivery_location' },
